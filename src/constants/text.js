...
export const FIELD_PROFI_MODE = "Profi Modus";
...
export const FIELD_YOUT_COMMENT = "Dein Kommentar";
...
export const FEED_TEXT = {
  ...
  RECIPE_CREATED: (text) => `hat das Rezept «${text}» erfasst.`,
  EVENT_CREATED: (text) => `hat den Anlass «${text}» erstellt.`,
  EVENT_COOK_ADDED: (text) => `wurde in das Team «${text}» aufgenommen.`,
