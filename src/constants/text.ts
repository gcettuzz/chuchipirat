...
export const BUTTON_ADD_MEAL = "Mahlzeit hinzufügen";
...
export const PANEL_ADMIN_JOBS = "Jobs ausführen";
...
export const PANEL_ADMIN_JOBS_DESCRIPTION = "Jobs manuel ausführen.";
/* =====================================================================
// Felder
// ===================================================================== */
...
export const FIELD_FROM = "Von";
export const FIELD_TO = "Bis";
...
export const FIELD_UNIT_ABREVIATION = "Einheit (Abkürzung)";
...
export const FIELD_SOURCE = "Quelle";
...
export const FIELD_NO_OF_SERVINGS = "Anzahl Portionen";
...
export const EVENT_PAST_EVENTS = "Vergangene Anlässe";
/* =====================================================================
...
export const DIALOG_SHOPPING_UNIT_INFO = "Für die Einheit «Stück» leer lassen";
...
export const UNITS_TAB_BASIC = "Basic";
export const UNITS_TAB_PRODUCTS = "Produktspezifisch";
...
export const MENUPLAN_DIALOG_ADD_RECIPE = (name) => {
  return `Rezept: ${name}`;
};
...
// Texte zu Anlass
// ===================================================================== */
export const DIALOG_TITLE_EVENT_ADD_PERSON = "Person ins Team aufnehmen";
/* =====================================================================
// Meldungen zum User
// ===================================================================== */
export const USER_ADD_BY_EMAIL = "Gib hier die E-Mailadresse der Person ein.";
// "Gib hier die E-Mailadresse der Person ein. Falls die Person noch keinen Account besitzt, wird die mittels Mail informiert.";
...
export const USER_NOT_IDENTIFIED_BY_EMAIL =
  "Die Person konnte anhand der E-Mailadresse nicht eindeutig ermittelt werden.";
/* =====================================================================
// Texte zum Profil
// ===================================================================== */
export const FOUND_TREASURES = "Gefundene Schätze";
export const RECIPES_CREATED = "erfasste Rezepte";
...
// Meldungen zu Einheiten
// ===================================================================== */
export const DIALOG_TITLE_UNIT_CREATE = "Neue Einheit anlegen";
export const DIALOG_TEXT_UNIT_CREATE =
  "Erfasse die neue Einheit gleich mit den nötigen Infos.";
export const DIALOG_ERROR_UNIT_CONVERSION_TYPE_MISSING =
  "Kein Typ gewählt. Speichern nicht möglich.";
export const DIALOG_TITLE_UNIT_CONVERSION_CREATE =
  "Neue Einheitenumrechnung anlegen";
export const DIALOG_TEXT_UNIT_CONVERSION_CREATE =
  "Erfasse die neue Umrechnung.";
export const DIALOG_UNIT_CONVERSION_PRODUCT_ALERT_TITLE = "Metrisches System";
export const DIALOG_UNIT_CONVERSION_PRODUCT_ALERT_TEXT =
...
// FormValidation
// ===================================================================== */
export const FORM_GIVE_VALID_EMAIL = "Bitte gültige E-Mailadresse angeben";
export const FORM_GIVE_UNIT = "Bitte Einheit angeben.";
export const FORM_GIVE_PRODUCT = "Bitte Produkt wählen.";
export const FORM_GIVE_GREATE_ZERO = "Bitte Wert grösser 0 angeben.";
...
export const FEED_TEXT = {
  ...
  RECIPE_CREATED: (textElements) =>
    `hat das Rezept «${textElements[0]}» erfasst.`,
  RECIPE_RATED: (textElements) => {
    switch (textElements[1]) {
      case "5":
        return "findet es superlecker und vergibt 5 ⭐️.";
      case "4":
        return "mag es und vergibt 4 ⭐️.";
      case "3":
        return "ist mässig überzeugt und vergibt 3 ⭐️.";
      case "2":
        return "mag lieber was anderes und vergibt 2 ⭐️.";
      case "1":
        return "mag das anscheinen nicht und vergibt 1 ⭐️";
      case "0":
