...
export class FirebaseDbRequestRecipeReviewActive extends FirebaseDbSuper {
  firebase: Firebase;
  ...
  getCollection(uids: string[]) {
    return this.firebase.db.collection("_requests/recipeReview/active");
  }
  /* =====================================================================
  ...
  getDocument(uids: string[]) {
    return this.firebase.db.doc(`_requests/recipeReview/active/${uids[0]}`);
  }
  /* =====================================================================
  // Dokumente holen
  // ===================================================================== */
...
export default FirebaseDbRequestRecipeReviewActive;
