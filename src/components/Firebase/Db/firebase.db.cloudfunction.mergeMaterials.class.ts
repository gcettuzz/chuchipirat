...
export class FirebaseDbCloudFunctionMergeMaterials extends FirebaseDbCloudFunctionSuper {
  firebase: Firebase;
  /* =====================================================================
  // Constructor
  // ===================================================================== */
  ...
  getDocument(uids: string[]) {
    return this.firebase.db.doc(
      `_cloudFunctions/functions/mergeMaterials/${uids[0]}`
    );
  }
  /* =====================================================================
  ...
  getCollection() {
    return this.firebase.db.collection(
      "_cloudFunctions/functions/mergeMaterials"
    );
  }
  /* =====================================================================
  ...
  getCloudFunctionType(): CloudFunctionType {
    return CloudFunctionType.mergeMaterials;
  }
}
export default FirebaseDbCloudFunctionMergeMaterials;
