...
export class FirebaseDbCloudFunctionDeclineRecipeRequest extends FirebaseDbCloudFunctionSuper {
  firebase: Firebase;
  /* =====================================================================
  // Constructor
  // ===================================================================== */
  ...
  getDocument(uids: string[]) {
    return this.firebase.db.doc(
      `_cloudFunctions/functions/declineRecipeRequest/${uids[0]}`
    );
  }
  /* =====================================================================
  ...
  getCollection() {
    return this.firebase.db.collection(
      "_cloudFunctions/functions/declineRecipeRequest"
    );
  }
  /* =====================================================================
  ...
  getCloudFunctionType(): CloudFunctionType {
    return CloudFunctionType.declineRecipeRequest;
  }
}
export default FirebaseDbCloudFunctionDeclineRecipeRequest;
