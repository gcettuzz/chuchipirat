...
export class FirebaseDbCloudFunctionUpdateMaterial extends FirebaseDbCloudFunctionSuper {
  firebase: Firebase;
  /* =====================================================================
  // Constructor
  // ===================================================================== */
  ...
  getDocument(uids: string[]) {
    return this.firebase.db.doc(
      `_cloudFunctions/functions/updateMaterial/${uids[0]}`
    );
  }
  /* =====================================================================
  ...
  getCollection() {
    return this.firebase.db.collection(
      "_cloudFunctions/functions/updateMaterial"
    );
  }
  /* =====================================================================
  ...
  getCloudFunctionType(): CloudFunctionType {
    return CloudFunctionType.updateMaterial;
  }
}
export default FirebaseDbCloudFunctionUpdateMaterial;
